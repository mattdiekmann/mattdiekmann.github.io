...
team_advantage <- home_perf %>%
  ...
  mutate(home_court_advantage = avg_home_diff - avg_away_diff)
```

Now we will plot the home_court_advantage value for every team to see who actually benefits the most from playing at home(rather than just being an elite franchise).
